# RWA Mockup · 商米硬件背书的 RWA 发行平台概念演示

> **R**eal-**W**orld **A**ssets · POS 硬件签名背书 · Solana 链上发行 · 真实餐饮经营数据驱动

这是 RWA 项目第一阶段的产品概念演示(mockup),包含 5 个核心页面 + 1 个索引页。
